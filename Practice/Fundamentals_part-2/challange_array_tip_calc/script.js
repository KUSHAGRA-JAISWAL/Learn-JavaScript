...
// above i have used arrow function to calculate the tip of any amount of the bill.

console.log(calcTip(100));
// testing the function using bill value as 100.

const bills = [125, 555, 44];
// created array of test data.

const tips = [calcTip(bills[0]), calcTip(bills[1]), calcTip(bills[2])];
// created array of tips where we have calculated and store the tip value using calcTip function.

console.log(tips);

const totals = [(bills[0] + tips[0]), (bills[1] + tips[1]), (bills[2] + tips[2])];
// created array which include total bill + tip.
